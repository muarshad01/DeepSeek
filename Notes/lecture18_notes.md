ne, my name is Dr. Raj
0:02
Dandkar. I graduated with a PhD in
0:05
machine learning from MIT in 2022 and
0:08
I'm the creator of the build deepseek
0:10
from scratch series. Before we get
0:12
started, I want to introduce all of you
0:15
to our sponsor and our partner for this
0:17
series invido AI. All of you know how
0:20
much we value foundational content
0:22
building AI models from the nuts and
0:24
bolts. Nvidia AI follows a very similar
0:28
principle and philosophy to that of us.
0:30
Let me show you how. So here's the
0:33
website of Invido AI. With a small
0:36
engineering team, they have built an
0:38
incredible product in which you can
0:40
create highquality AI videos from just
0:43
text prompts. So as you can see here,
0:46
I've mentioned a text prompt. Create a
0:49
hyper realistic video commercial of a
0:51
premium luxury watch and make it
0:53
cinematic. With that I click on generate
0:56
a
0:56
video. Within some time I'm presented
0:59
with this incredible video which is
1:02
highly
1:03
realistic. What fascinates me about this
1:05
video is its attention to detail. Look
1:08
at this. The quality and the texture is
1:10
just incredible. And all of this has
1:12
been created from a single text
1:15
prompt. That's the power of Invido's
1:18
product. The backbone behind the awesome
1:21
video which you just saw is Invido AI's
1:23
video creation pipeline in which they
1:26
are rethinking video generation and
1:28
editing from the first principles to
1:31
experiment and tinker with foundational
1:33
models. They have one of the largest
1:35
clusters of H100s and H200s in India and
1:38
are also experimenting with
1:41
B200s. Nvidia AI is the fastest growing
1:44
AI startup in India building for the
1:46
world and that's why I resonate with
1:48
them. so much. The good news is that
1:51
they have multiple job openings at the
1:53
moment. You can join their amazing team.
1:55
I'm posting more details in the
1:57
description
1:58
[Music]
2:02
below. Hello everyone and welcome to
2:05
this lecture in the build deepseek from
2:08
scratch series. In the previous lecture
2:11
we have or in the previous series of
2:13
lectures we have covered extensively the
2:17
major innovation of deepseek and that is
2:19
MLA or multi head latent
2:23
attention. Uh when deepseek introduced
2:26
latent attention they got the best of
2:28
both worlds. They reduced the KV cache
2:31
size and at the same time maintained
2:33
language performance and that was just
2:35
beautiful to
2:37
see. But along with latent attention,
2:40
one of the other major innovations which
2:42
deepseek made was something which is
2:44
called as mixture of
2:46
experts. And we are going to look at the
2:48
main idea of mixture of experts in
2:51
today's lecture. In the subsequent
2:53
lectures, we will get started with the
2:55
mathematics of mixtures of experts and
2:57
then we will see exactly what's the new
3:00
thing which
3:01
deep. Now one thing to note is that
3:04
mixture of experts as an idea has been
3:06
around for a very long time and when I
3:09
say very long time I mean really very
3:11
long time. The first paper which kind of
3:14
introduced mixture of experts was
3:16
actually in the 1990s. So here you see
3:19
this paper was published in neural
3:21
computation in 1991 and the name of this
3:24
paper was adaptive mixtures of local
3:27
experts. One of the authors was Joffrey
3:30
Newton who is of course the pioneer in
3:33
several machine learning domains
3:35
including back
3:37
propagation. So the idea of mixture of
3:39
experts it's not very new. Um and even
3:43
mixture of experts was implemented in
3:46
other language model architectures
3:47
before deepseek did it. Deepseek built
3:50
upon that innovation and added some new
3:53
tricks and techniques of their own. This
3:55
is what I believe DeepSync did so
3:57
nicely. Instead of reinventing the
3:59
wheel, they just borrowed what everyone
4:02
has done and built on top of that. Build
4:04
something really cool and
4:06
innovative. So this paper which I showed
4:08
you, adaptive mixtures of local experts,
4:11
this did not necessarily concern with
4:13
language modeling, right? They did not
4:16
introduce mixture of local experts for
4:18
language modeling. Um they used it for a
4:21
different task. They used it for
4:23
supervised learning.
4:25
U and they showed that using mixture of
4:27
experts we could do some very new things
4:29
with supervised learning algorithms and
4:33
then it was slowly brought into the
4:35
domain of language modeling through
4:37
Mistral and later through many other
4:40
uh many other players ultimately deepse
4:44
used all of that knowledge and built
4:46
something powerful on top of that. So
4:48
here I just wanted to give you a context
4:50
of mixture of experts its history um
4:55
and why I'm calling it a deepseek
4:58
innovation. So although I'm calling it a
5:00
deepseek innovation please note that
5:02
they were not the first to come up with
5:04
the name itself to come up with the idea
5:07
of mixture of experts. All right. So in
5:10
this lecture I'm going to give you just
5:12
an introduction and a visual feel of
5:14
what this whole idea of mixture experts
5:16
is.
5:18
So as I've written here another
5:19
innovation made by deepseek is a very
5:22
creative uses usage of a technique
5:24
called mixture of experts. Okay. So
5:26
first let's start understanding how
5:29
mixture of experts is used in language
5:31
modeling. In these series of lectures
5:33
